...
$_PRODUCT_NAME_TXT_$, hereinafter referred as the program, is used to render and
...
## $_PRODUCT_NAME_TXT_$ LICENSE

$_PRODUCT_NAME_TXT_$Create quizzes and lessons from plain text files. Copyright
$_BUILD_YEAR_$ Steve Butler (henspace.com)
...
The service worker used by $_PRODUCT_NAME_TXT_$ is generated using the  
